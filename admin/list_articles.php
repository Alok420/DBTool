                ...
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <DIV 
                            ...
                            <h3 class="service_title" style="text-align: center;">List Jobs</h3>
                            <div style="">
                                <?php
                                $db->showInTable("articles","id,image,title,views,date_time", array(), "all", $externallinks = "Article detail", array("image"=>"../img/articles/"), $sort);
                                ?>
                            </div>
